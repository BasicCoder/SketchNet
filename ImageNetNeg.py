...
def ImageNetNeg(_X, _weights, _biases, dropout_prob = 1.0):
    ...
    tf.summary.image('Image_Neg', _X, 20)
    # Layer 1
    with tf.name_scope('Image_Neg_L1') as scope:
        # Convolution Layer 1
    ...
    # Layer 2
    with tf.name_scope('Image_Neg_L2') as scope:
        # Convolution Layer 2
    ...
    # Layer 3
    with tf.name_scope('Image_Neg_L3') as scope:
        # Convolution Layer 3
    ...
    # Layer 4
    with tf.name_scope('Image_Neg_L4') as scope:
        #Convolution Layer 4
    ...
    # Layer 5
    with tf.name_scope('Image_Neg_L5') as scope:
        # Convolution Layer 5
    ...
    # Layer 6
    with tf.name_scope('Image_Neg_L6') as scope:
